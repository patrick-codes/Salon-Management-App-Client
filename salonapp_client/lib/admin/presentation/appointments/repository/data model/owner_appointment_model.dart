...
class OwnerAppointmentModel {
  ...
  OwnerAppointmentModel.defaultModel() {
    id = null;
    amount = 0.0;
    userId = "userId";
    ownerID = "ownerID";
  ...
  factory OwnerAppointmentModel.fromMap(Map<String, dynamic> data,
      {String? id}) {
    return OwnerAppointmentModel(
      id: id,
  ...
  factory OwnerAppointmentModel.fromSnapshot(
    ...
    if (document.exists) {
      ...
      return OwnerAppointmentModel.defaultModel();
    }
  }
}
